...
{
  // common
  bool enable_debug_info{true};  // DEFINE HERE
  ...
  double max_obj_lat_offset_to_ego_path{1.0};  // DEFINE HERE

  double max_front_object_angle{0.785};    // DEFINE HERE
  double min_crossing_object_vel{1.0};     // DEFINE HERE
  double max_crossing_object_angle{1.05};  // DEFINE HERE
